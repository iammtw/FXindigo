          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div
                class="text-center display-5 font-weight-bold text-primary text-uppercase mb-1"
              >
            <a href="#"  class="text-lg"> {{$demo->name}} </a>
              </div>
          <center>
            <alert class="alert-warning" style="font-weight: bold"> Leverage:   1:{{ $demo->leverage }} </alert> <br>
            <alert class="alert-danger" style="font-weight: bold"> Type:   {{ $demo->type }} </alert><br>
            <alert class="alert-primary" style="font-weight: bold"> Status:   {{ $demo->status }} </alert>
          </center>
            </div>
            <div class="col-auto">
              <i class="fas fa-cash-register fa-2x text-gray-300"></i>
